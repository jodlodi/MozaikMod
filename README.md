...
For mod if you wanted to remove support for `forge` you would follow the following steps:

1. Delete the subproject folder. For mod, delete `MultiLoader-Template/forge`.
2. Remove the project from `settings.gradle`. For mod, remove `include("forge")`. 
