...
public class CreatePolyominoButton extends ModButton {
	...
	private @Nullable Polyomino preBuilt = null;
	...
	public void onPress(InputWithModifiers inputWithModifiers) {
		...
		HeldPolyominoWidget widget = new HeldPolyominoWidget(this.screen, (int) (x - center.x * Tessera.TESSERA_SIZE), (int) (y - center.y * Tessera.TESSERA_SIZE), this.preBuilt);
